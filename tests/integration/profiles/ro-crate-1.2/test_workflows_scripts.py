...
_GENERIC_RECOMMENDED_SKIP = [
    ...
    "ro-crate-1.2_49.1",  # Root Data Entity: recommended funder
    "ro-crate-1.2_56.1",  # Root Data Entity: recommended publisher
    "ro-crate-1.2_63.1",  # File Data Entity: RECOMMENDED contentSize
    "ro-crate-1.2_64.0",  # File: RECOMMENDED conformsTo profile
    "ro-crate-1.2_76.1",  # Contextual Entity Properties
    "ro-crate-1.2_77.1",  # Contextual Entity RECOMMENDED description
    "ro-crate-1.2_82.2",  # License entity: RECOMMENDED properties
]
