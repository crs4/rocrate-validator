...
from tests.ro_crates_v1_3 import ReferencedROCrates
...
def test_valid_referenced_rocrate():
    ...
    do_entity_test(
        ...
        skip_checks=["ro-crate-1.3_40.0", "ro-crate-1.3_46.1", "ro-crate-1.3_72.1", "ro-crate-1.3_75.1"],
    )
...
def test_invalid_referenced_rocrate_missing_sddatepublished():
    ...
    triggers a RECOMMENDED warning (RO-Crate 1.3, § 4.5).
    """
    do_entity_test(
