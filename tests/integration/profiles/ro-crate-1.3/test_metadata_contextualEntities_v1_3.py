...
from tests.ro_crates_v1_3 import ContextualEntities
...
def test_info_encoding_format_no_webpageelement():
    ...
    triggers an `sh:Info` suggestion at OPTIONAL severity (RO-Crate 1.3, § 5.8).
    """
    do_entity_test(
...
def test_info_software_application_no_alternatename():
    ...
    (RO-Crate 1.3, § 5.7).  The existing `valid` SoftwareApplication crate
