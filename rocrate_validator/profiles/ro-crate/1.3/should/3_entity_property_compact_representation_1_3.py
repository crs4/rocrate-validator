...
class EntityPropertyCompactRepresentation(PyFunctionCheck):
    ...
    single value in compacted RO-Crate 1.3 JSON-LD.
    """
    ...
    def check_singleton_property_arrays(self, context: ValidationContext) -> bool:
        """Check the RO-Crate 1.3 recommendation for singleton property arrays."""
        try:
        ...
        for entity_id, property_name in findings:
            context.result.add_issue(
                ...
                "not a singleton array, according to the RO-Crate 1.3 JSON-LD recommendation",
                self,
